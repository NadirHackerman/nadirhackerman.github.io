const translations = {
  en: {
    ...
    'achievements.tag': 'Notable Work',
    'achievements.title': 'Key Achievements',
    'achievements.arch.title': 'Monolith to Microservices',
    'achievements.arch.desc': 'Led the full migration of a legacy monolithic application to a distributed microservices architecture, orchestrated with Kubernetes. Improved scalability, deployment independence, and fault isolation across services.',
    'achievements.ai.title': 'AI Features via LLMs',
    'achievements.ai.desc': 'Integrated large language model capabilities into existing SaaS products to automate workflows, enhance user experience, and surface intelligent insights without rebuilding the core platform.',
    'achievements.media.title': 'Media Processing Pipeline',
    'achievements.media.desc': 'Built a multi-stage image processing pipeline combining AI-powered editing components with algorithmic transformations, handling high-throughput media workloads with parallelism and fault tolerance.',
    'achievements.data.title': 'Data Analytics Integration',
    'achievements.data.desc': 'Designed and implemented API integrations and data ingestion pipelines feeding real-time and batch analytics systems, enabling reliable data flow from diverse sources into analytics platforms.',
  ...
  fr: {
    ...
    'nav.achievements': 'Points forts',
    'achievements.tag': 'Réalisations',
    'achievements.title': 'Faits marquants',
    'achievements.arch.title': 'Monolithe vers Microservices',
    'achievements.arch.desc': "Pilotage de la migration complète d'une application monolithique vers une architecture microservices distribuée, orchestrée avec Kubernetes. Amélioration de la scalabilité, de l'indépendance des déploiements et de l'isolation des pannes.",
    'achievements.ai.title': 'Intégration IA via LLMs',
    'achievements.ai.desc': "Intégration de modèles de langage (LLMs) dans des produits SaaS existants pour automatiser des workflows, enrichir l'expérience utilisateur et faire remonter des insights intelligents, sans reconstruire la plateforme.",
    'achievements.media.title': 'Pipeline de traitement média',
    'achievements.media.desc': "Construction d'un pipeline multi-étapes de traitement d'images combinant des composants d'édition par IA et des transformations algorithmiques, gérant des charges de travail média à fort débit avec parallélisme et tolérance aux pannes.",
    'achievements.data.title': 'Intégration analytique',
    'achievements.data.desc': "Conception et mise en place d'intégrations API et de pipelines d'ingestion de données alimentant des systèmes analytiques temps réel et par lots, garantissant un flux fiable depuis des sources diverses vers des plateformes d'analyse.",
